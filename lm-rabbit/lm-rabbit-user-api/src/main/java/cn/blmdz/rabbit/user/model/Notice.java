...
/**
 * Created Date : 16/7/29 Author : wujianwei
 */
@Data
public class Notice implements Serializable {
	...
	public static enum Status {
		INIT(0, "初始化"), RELEASE(1, "发布"), STOP(2, "停止"), DELETE(3, "删除");
	...
	public Boolean isCurrentEffective() {
		...
		return now.isAfter(new DateTime(this.startAt)) && now.isBefore(new DateTime(this.endAt));
	}
