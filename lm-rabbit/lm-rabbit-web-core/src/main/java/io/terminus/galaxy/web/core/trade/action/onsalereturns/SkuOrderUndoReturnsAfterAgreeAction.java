 ...
 * 退货申请同意后取消申请
 *
 * 退货单: 更新状态为SKU_RETURNS_UNDO, 更新操作集合
 * 子订单: 不更新状态, 重新打开所有操作
 ...
 */
@Component
public class SkuOrderUndoReturnsAfterAgreeAction extends OnSaleReturnActionBase implements TradeAction<Boolean> {
    ...
    @Autowired
    public SkuOrderUndoReturnsAfterAgreeAction(
    ...
    public Boolean execute(Map<String, Serializable> context) {
         ...
         * 退货单: 更新状态为SKU_RETURNS_UNDO, 更新操作集合
         */
        skuOrderRefund.setNodeInstanceId(OrderStatus.SKU_RETURNS_AGREE_UNDO.value());
