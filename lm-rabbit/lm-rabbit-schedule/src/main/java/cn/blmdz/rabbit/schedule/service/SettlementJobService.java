...
import cn.blmdz.rabbit.settlement.config.SettlementSetting;
...
import cn.blmdz.wolf.settlement.service.SettlementWriteService;
   ...
   /* @Autowired
        ...
        try {
            ...
            for (Long id : ids) {
                ...
                if(type.equals(PayChannelType.PAID)){
                    ...
                    detail.setFee((long)channel.getFee());
                }else {
                    detail.setFee(0l - (long)(channel.getFee()));
                }
    ...
    private void checkFee( ThirdPartyFeeDto dto,PayChannelDetail detail){
        ...
        if(dto.getFee().equals(Math.abs(detail.getFee()))){
            ...
            update.setThirdPartyFee(dto.getThirdPartyFee() == null?0l:dto.getThirdPartyFee());
            update.setThirdPartyRate(dto.getThirdPartyRate() == null?0:NumberSwitch.getTransFormRate(dto.getThirdPartyRate()));
