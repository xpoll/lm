...
public class ConfigCenter {
   ...
   private LoadingCache properties = CacheBuilder.newBuilder().expireAfterWrite(3000L, TimeUnit.SECONDS).build(new CacheLoader<String, Optional>() {
   ...
   public Map commit(Operator op, List<Config> configs) {
