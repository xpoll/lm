...
import io.terminus.parana.web.core.events.spu.SpuCreatedEvent;
import io.terminus.parana.web.core.events.spu.SpuDeletedEvent;
import io.terminus.parana.web.core.events.spu.SpuUpdatedEvent;
...
public class Spus {
   ...
   private void extractInfoFromSkus(Spu spu, List skuTemplates) {
