...
import io.terminus.parana.component.dto.attribute.GroupedOtherAttributeWithRule;
import io.terminus.parana.component.dto.attribute.OtherAttributeWithRule;
import io.terminus.parana.rule.RuleExecutor;
import io.terminus.parana.rule.attribute.AttributeRuleBuilder;
...
public abstract class OtherAttributeRuleByCategoryExecutor extends RuleExecutor {
   ...
   private List groupOtherAttributeWithRules(List otherAttributeWithRules) {
      Multimap<String, OtherAttributeWithRule> byGroup = Multimaps.index(otherAttributeWithRules, new Function() {
