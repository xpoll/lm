package cn.blmdz.wolf.pay.impl.service;
...
import cn.blmdz.wolf.pay.enums.PayInfoDto;
import cn.blmdz.wolf.pay.impl.dao.AlipayTransDao;
import cn.blmdz.wolf.pay.impl.dao.ExceptionPayTrackDao;
import cn.blmdz.wolf.pay.impl.dao.OwnerPayChannelDao;
import cn.blmdz.wolf.pay.impl.dao.PayChannelDao;
import cn.blmdz.wolf.pay.impl.dao.PayStageDao;
import cn.blmdz.wolf.pay.impl.dao.TradePayDao;
import cn.blmdz.wolf.pay.impl.dao.WechatpayTransDao;
import cn.blmdz.wolf.pay.impl.gateway.PayGateway;
...
public class PayReadServiceImpl implements PayReadService {
   ...
   public Response<PayStage> findPayStageById(Long id) {
   ...
   public Response<PayChannel> findPayChannelById(Long id) {
   ...
   public Response findPayInfo(String systemNo, Integer stage) {
      ...
      try {
         ...
         if(Arguments.notNull(stage) && stage.equals(Integer.valueOf(0))) {
            ...
            List<Long> stageIds = Lists.transform((List)payStageRes.getResult(), new Function<PayStage, Long>() {
   ...
   public Response pagingTimeoutPayTracks(Integer pageNo, Integer pageSize, Map<String, Object> criteria) {
   ...
   public Response<ExceptionPayTrack> getTimeoutPayTrackById(Long id) {
   ...
   private Map<String, Object> filterNullOrEmpty(Map<String, Object> criteria) {
