...
import cn.blmdz.wolf.pay.impl.dao.KjtpayTransDao;
...
import cn.blmdz.wolf.pay.impl.manager.PayManager;
...
public class PayWriteServiceImpl implements PayWriteService {
   ...
   public Response updateStageFee(String systemNo, Map<Integer, Integer> stageFees) {
   ...
   public Response createTradePayWithStage(TradePay tradePay, List<PayStageInfo> stageInfos, Date expirePayTime) {
      Response<Boolean> result = new Response();
