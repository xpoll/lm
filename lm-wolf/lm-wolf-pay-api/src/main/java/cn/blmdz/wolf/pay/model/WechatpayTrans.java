...
public class WechatpayTrans implements Serializable {
   ...
   public boolean equals(Object o) {
      if(o == this) {
         return true;
      } else if(!(o instanceof WechatpayTrans)) {
         return false;
      } else {
         WechatpayTrans other = (WechatpayTrans)o;
   ...
   public boolean canEqual(Object other) {
      return other instanceof WechatpayTrans;
   }
