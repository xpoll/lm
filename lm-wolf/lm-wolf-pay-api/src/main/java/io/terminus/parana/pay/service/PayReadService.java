...
public interface PayReadService {
   ...
   Response pagingTimeoutPayTracks(Integer var1, Integer var2, Map var3);

   Response getTimeoutPayTrackById(Long var1);

   Response getThirdPartyFeeForward(@NotNull(
   message = "payment.code.is.null"
) String var1, @NotNull(
   message = "channel.is.null"
) String var2);

   Response getThirdPartyFeeReverse(@NotNull(
   message = "payment.code.is.null"
) String var1, @NotNull(
   message = "channel.is.null"
) String var2);
