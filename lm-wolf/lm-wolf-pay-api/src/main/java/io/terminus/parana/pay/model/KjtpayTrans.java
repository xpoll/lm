...
public class KjtpayTrans implements Serializable {
   ...
   public boolean equals(Object o) {
      if(o == this) {
         return true;
      } else if(!(o instanceof KjtpayTrans)) {
         return false;
      } else {
         KjtpayTrans other = (KjtpayTrans)o;
   ...
   public boolean canEqual(Object other) {
      return other instanceof KjtpayTrans;
   }
   ...
   public String toString() {
      return "KjtpayTrans(id=" + this.getId() + ", outerNo=" + this.getOuterNo() + ", origOuterNo=" + this.getOrigOuterNo() + ", innerNo=" + this.getInnerNo() + ", type=" + this.getType() + ", orderAt=" + this.getOrderAt() + ", paidAt=" + this.getPaidAt() + ", amount=" + this.getAmount() + ", rate=" + this.getRate() + ", rateFee=" + this.getRateFee() + ", status=" + this.getStatus() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ")";
   }
}
