...
public abstract class MsgTemplateApplicationBase implements MsgTemplateApplication {
   ...
   static {
      handlebars.registerHelper("assign", new Helper() {
      ...
      handlebars.registerHelper("json", new Helper() {
         public CharSequence apply(Object context, Options options) throws IOException {
            return JsonMapper.nonEmptyMapper().toJson(context);
         }
      });
      handlebars.registerHelper("match", new Helper() {
      ...
      handlebars.registerHelper("mod", new Helper() {
      ...
      handlebars.registerHelper("size", new Helper() {
         public CharSequence apply(Object context, Options options) throws IOException {
      ...
      handlebars.registerHelper("formatDate", new Helper() {
      ...
      handlebars.registerHelper("formatPrice", new Helper() {
      ...
      handlebars.registerHelper("formatIntegerRate", new Helper() {
