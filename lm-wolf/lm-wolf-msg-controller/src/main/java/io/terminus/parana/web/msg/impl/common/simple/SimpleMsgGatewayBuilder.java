...
public class SimpleMsgGatewayBuilder implements MsgGatewayBuilder, ApplicationContextAware {
   private static final Logger log = LoggerFactory.getLogger(SimpleMsgGatewayBuilder.class);
