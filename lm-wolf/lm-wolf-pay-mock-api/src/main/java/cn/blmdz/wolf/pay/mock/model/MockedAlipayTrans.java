...
public class MockedAlipayTrans implements Serializable {
   ...
   public boolean equals(Object o) {
      if(o == this) {
         return true;
      } else if(!(o instanceof MockedAlipayTrans)) {
         return false;
      } else {
         MockedAlipayTrans other = (MockedAlipayTrans)o;
   ...
   public boolean canEqual(Object other) {
      return other instanceof MockedAlipayTrans;
   }
