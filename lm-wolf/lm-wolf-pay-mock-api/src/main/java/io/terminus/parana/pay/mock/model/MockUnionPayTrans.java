...
public class MockUnionPayTrans implements Serializable {
   private static final long serialVersionUID = 5653876869773667266L;
   private Long id;
   ...
   public boolean equals(Object o) {
      if(o == this) {
         return true;
      } else if(!(o instanceof MockUnionPayTrans)) {
         return false;
      } else {
         MockUnionPayTrans other = (MockUnionPayTrans)o;
   ...
   public boolean canEqual(Object other) {
      return other instanceof MockUnionPayTrans;
   }
