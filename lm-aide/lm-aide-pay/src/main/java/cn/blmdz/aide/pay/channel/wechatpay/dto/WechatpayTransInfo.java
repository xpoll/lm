...
public class WechatpayTransInfo implements Serializable {
   private static final long serialVersionUID = -6151999316190888499L;
   ...
   public boolean equals(Object o) {
      if(o == this) {
         return true;
      } else if(!(o instanceof WechatpayTransInfo)) {
         return false;
      } else {
         WechatpayTransInfo other = (WechatpayTransInfo)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof WechatpayTransInfo;
   }
   ...
   public int hashCode() {
      ...
      result = result * 59 + ($transactionId == null?0:$transactionId.hashCode());
      Object $outTradeNo = this.getOutTradeNo();
      result = result * 59 + ($outTradeNo == null?0:$outTradeNo.hashCode());
      Object $tradeStatus = this.getTradeStatus();
      result = result * 59 + ($tradeStatus == null?0:$tradeStatus.hashCode());
      Object $tradeTime = this.getTradeTime();
      result = result * 59 + ($tradeTime == null?0:$tradeTime.hashCode());
