...
import cn.blmdz.aide.pay.channel.kjtpay.util.Core;
...
public class verifyClient {
	...
	public verifyClient(String cvmConfigFile, String keyPassword, String pfxFileName) {
		itrus.setCvmConfigFile(cvmConfigFile);
		itrus.setKeyPassword(keyPassword);
		itrus.setPfxFileName(pfxFileName);
		itrus.init();
	}
