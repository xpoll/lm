...
public class DubboAutoConfiguration {
	...
	@Bean(name = { "com.alibaba.dubbo.config.ApplicationConfig" })
	...
	@Bean(name = { "com.alibaba.dubbo.config.RegistryConfig" })
	...
	@Bean(name = { "com.alibaba.dubbo.config.ProtocolConfig" })
	...
	public DubboServiceListenerBean dubboServiceListenerBean() {
		return new DubboServiceListenerBean(
				(String) MoreObjects.firstNonNull(this.dubboProperties.getName(), this.appName));
	}
}
